...
This tool could be useful to carry out text mining and sentiment analysis on the Mexican President's press conferences.
...
```{r text_extraction, warning=FALSE,message=FALSE}
